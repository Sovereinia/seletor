...
export const desktopHeaders: HeaderEntry[] = [
  {
...
export const mobileHeaders: HeaderEntry[] = [
  {
    subtitle: 'Alternativas de código aberto para apps famosos.',
  },
  {
    subtitle: 'Conheça apps descentralizados mantidos pela comunidade.',
  },
  {
